...
@echo off
echo Run copype amd64 C:\WinPE_amd64 in Deployment Envroiment. When its done press any key
pause
...
echo Adding drivers
Dism /Image:C:\WinPE_amd64\mount\ /Add-Driver /Driver:drivers /Recurse

echo Copy files
xcopy startnet.cmd C:\WinPE_amd64\mount\windows\system32\ /y
