...
Construct() {
	...
	CheckBox1 := myGui.Add("CheckBox", "x288 y190 w110 h15", "Show USB drives")
	ButtonRefreshDisks := myGui.Add("Button", "x376 y144 w80 h23", "Refresh Disks")
	DropDownList1 := myGui.Add("DropDownList", "x32 y459 w100", ["UEFI Format", "LEGACY Format"])
	...
	myGui.Add("Text", "x32 y432 w200 h22")
	ButtonRefreshImages := myGui.Add("Button", "x376 y432 w80 h30", "Refresh Images")
